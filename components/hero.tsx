  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          Full-Stack Web Developer specializing in modern web applications, scalable backends,
          and performant frontends. React, Next.js, NestJS, Node.js, and distributed systems.
        </motion.p>
